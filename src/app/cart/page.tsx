...
const Cart = () => {
 const router = useRouter()
  const {  cartItems, addToCart,decreamentQuantity,totalItems} = useContext(ProductContext);
                    ...
                    <tr key={item._id}>
                      <td className="flex items-center gap-4 py-4 md:px-4 px-1">
                        <div>
                          ...
                          <button
                            ...
                            onClick={() => decreamentQuantity(item._id)}
                          >
                            Remove
                          </button>
                        </div>
                      ...
                      <td className="py-4 md:px-4 px-1">
                        <div className="flex items-center md:gap-2 gap-1">
                          <button onClick={() => decreamentQuantity(item._id)}>
                            <Image
                         ...
                         // onChange={e => updateCartQuantity(product._id, Number(e.target.value))}
                           type="number" value={item.quantity} className="w-8 border text-center appearance-none"></input>
